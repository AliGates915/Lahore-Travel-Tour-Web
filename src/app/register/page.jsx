      ...
      <div className="relative w-full max-w-[800px] sm:h-[600px] bg-white rounded-3xl shadow-2xl flex overflow-hidden">
        ...
        <div className="w-full sm:w-1/2 flex items-center justify-center bg-gray-50 sm:rounded-l-[50px] p-6 sm:p-0">
          <div className="w-full max-w-[320px]">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2 text-center sm:text-left">
              Create your account!
            </h2>

            <p className="text-sm text-lightgrayish mb-6">
            ...
            <form className="space-y-4">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-secondary"
              />
              ...
              <button
                type="submit"
                className="w-full py-2 rounded-md text-sm bg-gradient-to-r from-primary to-primary-mid text-white font-medium hover:opacity-90 transition"
              >
                Continue
              </button>
            </form>

            <p className="text-xs text-lightgrayish mt-6 text-center">
